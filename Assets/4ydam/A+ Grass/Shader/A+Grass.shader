Shader "4ydam/A+Grass"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			// Dummy συνάρτηση για τη διόρθωση του CalcNdcMotionVectorFromCsPositions
			#ifndef CalcNdcMotionVectorFromCsPositions
			inline float2 CalcNdcMotionVectorFromCsPositions(float4 positionCS, float4 previousPositionCS)
			{
		...
		Pass
		{
			...
			// Διόρθωση για το GBufferFragOutput σε παλαιότερες εκδόσεις URP
			#ifndef GBufferFragOutput
			#define GBufferFragOutput FragmentOutput
			#endif
				 ...
				 )
			{
				...
				surfaceData.occlusion = 1;
							...
							return SurfaceDataToGbuffer( surfaceData, inputData, globalIllumination, 0);
						}
